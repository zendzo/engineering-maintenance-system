<li class="treeview {{ active(['admin.setting.*']) }}">
  ...
  <ul class="treeview-menu">
    ...
    <li class="{{ active('admin/setting/location') }}"><a href="{{ route('admin.setting.type','location') }}"><i class="fa fa-bars"></i> WO Category</a></li>
    <li class="{{ active('admin/setting/location') }}"><a href="{{ route('admin.setting.type','location') }}"><i class="fa fa-truck"></i> Asset Supplier</a></li>
