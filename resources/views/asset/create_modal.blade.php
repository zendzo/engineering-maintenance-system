<div class="modal fade" id="addNewAsset" tabindex="-1" role="dialog" aria-labelledby="addNewAssetLabel">
        ...
        <div class="modal-body">
            <form role="form"  action="{{ route('admin.asset.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group{{ $errors->has('property') ? ' has-error' : '' }}">
                  ...
                  <input class="form-control" name="property" type="text" required autocomplete="off">
                ...
                <div class="form-group{{ $errors->has('supplier_id') ? ' has-error' : '' }}">
                  ...
                  <div class="form-group{{ $errors->has('model') ? ' has-error' : '' }}">
                      ...
                      <input class="form-control" type="text" name="model" id="merk">
                        @if ($errors->has('model'))
                            <span class="help-block">
                                <strong>{{ $errors->first('name') }}</strong>
                            </span>
                  ...
                  <div class="form-group{{ $errors->has('purcashed_at') ? ' has-error' : '' }}">
                      ...
                      <input class="form-control" type="text" name="purcashed_at" id="purcashed_at" autocomplete="off">
